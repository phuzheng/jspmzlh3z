...
<body>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">宠物百科展示</span>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in chongwubaikeList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../chongwubaike/detail.jsp?id='+item.id)">
                        <img :src="item.chongwutupian?item.chongwutupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.chongwumingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../chongwubaike/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">饲料购买展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in siliaogoumaiList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../siliaogoumai/detail.jsp?id='+item.id)">
                        <img :src="item.siliaotupian?item.siliaotupian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.siliaomingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../siliaogoumai/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-assist">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">宠物服务机构展示</span>
              <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            <span class="ng-inmod-thebor" aos="fade-up"></span>
          </div>
          ...
          <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
            <div class="ng-incontlst-doc ng-incontlst-doc-show">
              <div class="row">
                <div class="ng-incontlst-col" v-for="(item,index) in chongwufuwujigouList" v-bind:key="index">
                  <div class="ng-incontlst-bor">
                    <div class="ng-incontlst-img ng-oa ng-fault">
                      <a href="javascript:void(0);" @click="jump('../chongwufuwujigou/detail.jsp?id='+item.id)">
                        <img :src="item.jigouzhaopian?item.jigouzhaopian.split(',')[0]:''" />
                      </a>
                    </div>
                    <div class="ng-fault ng-container">
                      <div class="ng-incontlst-tit">
                        <p>{{item.jigoumingcheng}}</p>
                        <p style="color: red;" v-if="item.price">{{item.price}} RMB</p>
                        <span></span>
                      </div>
                      <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../chongwufuwujigou/detail.jsp?id='+item.id)">查看详情</a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`chongwubaike/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.chongwubaikeList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`siliaogoumai/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.siliaogoumaiList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
      http.request(`chongwufuwujigou/list`, 'get', {
        page: 1,
        limit: 10
      }, function(res) {
        vue.chongwufuwujigouList = res.data.list;
        vue.$nextTick(()=>{
          window.xznResize();
        });
      });
