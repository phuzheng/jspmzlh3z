...
public class YonghuEntity<T> implements Serializable {
	...
	@DateTimeFormat 		
	private Date chongwushangciyimiaoriqi;
	 ...
	 * 设置：宠物上次疫苗日期
	 */
	public void setChongwushangciyimiaoriqi(Date chongwushangciyimiaoriqi) {
		this.chongwushangciyimiaoriqi = chongwushangciyimiaoriqi;
	}
	/**
	 * 获取：宠物上次疫苗日期
	 */
	public Date getChongwushangciyimiaoriqi() {
		return chongwushangciyimiaoriqi;
	}
	/**
	 * 设置：宠物类别
	 */
